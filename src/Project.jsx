                                ...
                                <div className="mx-auto mb-20 bg-[#001227] shadow-[0_0_30px_rgba(255,255,255,0.2)] max-w-[900px]">
                                    <ul className="">
                                        <li key={ele.id} className="">
                                            <a href={ele.Link} className="mx-auto sm:flex" target="_blank" rel="noopener noreferrer"><img className="sm:max-w-[350px] " src={ele.image} key={ele.id} alt="Gestion_Etudiant" />
